        ...
        <div class="col-12">
          <div class="card">
            ...
            <div class="card-body">
              ...
              <form action="<?= base_url('/admin/simpanJurusan') ?>" method="post" autocomplete="off">
              <?= csrf_field(); ?>
                <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control <?= $validation->hasError('nama_jurusan') ? ' is-invalid' : ''; ?>  " name="nama_jurusan" required autofocus value="<?= old('nama_jurusan'); ?>">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control <?= $validation->hasError('keterangan') ? ' is-invalid' : ''; ?> " name="keterangan" required autofocus value="<?= old('keterangan') ?>">
                    <div class="invalid-feedback">
