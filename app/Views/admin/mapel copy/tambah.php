...
<section class="section">
          ...
          <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
              ...
              <div class="breadcrumb-item"><a href="/admin/mapel">Mata Pelajaran</a></div>
          ...
          <div class="row">
              <div class="col-12">
                <div class="card">
                  ...
                  <div class="card-body">
                   <form action="<?=base_url('/admin/simpanMapel')?>"method="post" autocomplete="off" enctype="multipart/form-data">
                   <?=csrf_field();?>
                    <div class="form-group">
                      <div class="form-group">
                        <label for="nama_mapel">Nama Mata pelajaran :</label>
                        <input type="text" class="form-control" name="nama_mapel" required autofocus <?php if(session('errors.nama_mapel')) : ?>is-invalid<?php endif ?>  value="<?= old('nama_mapel') ?>">
                      </div>
                      <div class="">
